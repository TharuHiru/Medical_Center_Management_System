...
import { getFirestore, collection, query, orderBy, where, onSnapshot, addDoc } from "firebase/firestore";
...
export { db, collection, query, orderBy, where, onSnapshot, addDoc };
